#!/usr/bin/env bash
# On-policy distillation | vision (Qwen3.5) | vLLM rollout | FSDP training | 8x H200, split 4 train + 4 teacher
...
experiment_name=${EXPERIMENT_NAME:-qwen3_5_4b_from_qwen3_5_9b_h200_4x4_vllm_fsdp}
# ---- end user-adjustable ----
...
python3 -m verl.trainer.main_ppo \
    ...
    "${TRAINER[@]}" \
    "${EXTRA[@]}" \
    "$@" 2>&1 | tee logs/qwen3_5-9b-h200-4x4-fsdp2-${start_time}.log
