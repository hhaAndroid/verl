...
layer_configs = [
    {'type': DPModel, 'num_gpus': 1, 'input_size': 2, 'output_size': 6},  # 放置于 gpu0 上，虚假的占据 0.2
    {'type': ColumnTPModel, 'num_gpus': 2, 'input_size': 6, 'output_size': 8}, # 放置于 gpu0/1 上，虚假的占据 0.2
    {'type': DPModel, 'num_gpus': 2, 'input_size': 8, 'output_size': 4} # 放置于 gpu0/1 上，虚假的占据 0.2
]
# 注意：虽然多个模型放到了同一张卡上，但是实际上是不同进程，无法通信。
